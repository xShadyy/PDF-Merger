...
3. Download PyPDF2 library by typing in cmd: `pip install PyPDF2`
4. Download the script.
5. Run the script.
6. Enjoy!

⚠️Script will only work if the python file is in the same directory as the PDF's.
